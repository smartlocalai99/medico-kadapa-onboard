        ...
        <div className="space-y-3">
          {currentMedicines.map((med) => {
            ...
            return (
              <div 
                key={med.id} 
                className="bg-white border border-slate-200 p-4 rounded-2xl flex items-center justify-between gap-4 hover:border-slate-300 transition shadow-xs"
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  {med.image_url ? (
                    ...
                    <button 
                      ...
                      className="w-12 h-12 rounded-xl border border-dashed border-slate-300 hover:border-emerald-500/50 hover:text-emerald-600 bg-slate-50 flex flex-col items-center justify-center text-slate-400 shrink-0 transition cursor-pointer"
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-1.5 items-center">
                      ...
                      {hospitalNames.length > 0 ? (
                        ...
                        <span className="text-[9px] bg-slate-50 text-slate-400 px-2 py-0.5 rounded font-medium">
                          No hospital uploads
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  {med.image_url && (
                    <button
                      ...
                      className="text-[10px] font-bold uppercase tracking-wider px-3 py-2.5 rounded-xl border border-rose-100 text-rose-500 hover:bg-rose-50 hover:text-rose-700 cursor-pointer active:scale-95 disabled:opacity-40"
                    >
